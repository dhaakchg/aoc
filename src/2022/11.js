...
module.exports = input => {
  ...
  const totalMonkeyBusiness = monkeys.map(monkey => monkey.monkeyBusiness).sort((a, b) => b - a).slice(0,2)
  return [totalMonkeyBusiness.reduce((a, n) => a * n), 'p2']
}
